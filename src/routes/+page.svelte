...
<div class="home">
  <section
    class="relative py-24 bg-gradient-to-r from-gray-900 to-gray-800 text-white"
  >
    ...
    <div class="container relative z-10 text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a href={content.shabbatLink} class="btn-secondary"
  ...
  <section class="image-gallery">
    <div class="flex justify-center">
      ...
      <img
        ...
        alt="Homepage Image"
        class="max-w-4xl w-full object-cover"
      />
    </div>
  </section>
...
<style lang="postcss">
  ...
  .btn-secondary {
    @apply bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold
